...
index.search = function(req,res){
	...
	// 设置监听 
	ep.all('topicData','cateData','page','pageMax','tab','replyData','wuData','goldData','webData','catetopData','kindData','search',function(topicData,cateData,page,pageMax,tab,replyData,wuData,goldData,webData,catetopData,kindData,search){
		// 关联查询 -- 以设置user(存储是用户的_id)
		// console.log(111);
		// console.log(topicData[0].user.uname);
